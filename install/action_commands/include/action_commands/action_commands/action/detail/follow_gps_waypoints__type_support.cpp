...
{
  new (message_memory) action_commands::action::FollowGPSWaypoints_Goal(_init);
}

void FollowGPSWaypoints_Goal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_commands::action::FollowGPSWaypoints_Goal *>(message_memory);
  typed_message->~FollowGPSWaypoints_Goal();
}

size_t size_function__FollowGPSWaypoints_Goal__gps_poses(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<geometry_msgs::msg::GeoPose> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<geometry_msgs::msg::GeoPose> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<geometry_msgs::msg::GeoPose> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::GeoPose *>(
    get_const_function__FollowGPSWaypoints_Goal__gps_poses(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::GeoPose *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::GeoPose *>(
    get_function__FollowGPSWaypoints_Goal__gps_poses(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::GeoPose *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FollowGPSWaypoints_Goal_message_member_array[3] = {
  {
    ...
    offsetof(action_commands::action::FollowGPSWaypoints_Goal, number_of_loops),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_Goal, goal_index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<geometry_msgs::msg::GeoPose>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_Goal, gps_poses),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FollowGPSWaypoints_Goal_message_members = {
  "action_commands::action",  // message namespace
  "FollowGPSWaypoints_Goal",  // message name
  3,  // number of fields
  sizeof(action_commands::action::FollowGPSWaypoints_Goal),
...
{
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_Goal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_Goal)() {
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_Goal_message_type_support_handle;
}
...
void FollowGPSWaypoints_Result_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) action_commands::action::FollowGPSWaypoints_Result(_init);
}

void FollowGPSWaypoints_Result_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_commands::action::FollowGPSWaypoints_Result *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<action_commands::msg::MissedWaypoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<action_commands::msg::MissedWaypoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<action_commands::msg::MissedWaypoint> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__FollowGPSWaypoints_Result__missed_waypoints(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const action_commands::msg::MissedWaypoint *>(
    get_const_function__FollowGPSWaypoints_Result__missed_waypoints(untyped_member, index));
  auto & value = *reinterpret_cast<action_commands::msg::MissedWaypoint *>(untyped_value);
  value = item;
}
...
void assign_function__FollowGPSWaypoints_Result__missed_waypoints(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<action_commands::msg::MissedWaypoint *>(
    get_function__FollowGPSWaypoints_Result__missed_waypoints(untyped_member, index));
  const auto & value = *reinterpret_cast<const action_commands::msg::MissedWaypoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FollowGPSWaypoints_Result_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<action_commands::msg::MissedWaypoint>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_Result, missed_waypoints),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FollowGPSWaypoints_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(action_commands::action::FollowGPSWaypoints_Result),
...
{
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_Result_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_Result)() {
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_Result_message_type_support_handle;
}
...
void FollowGPSWaypoints_Feedback_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) action_commands::action::FollowGPSWaypoints_Feedback(_init);
}

void FollowGPSWaypoints_Feedback_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_commands::action::FollowGPSWaypoints_Feedback *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FollowGPSWaypoints_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_Feedback, current_waypoint),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FollowGPSWaypoints_Feedback_message_members = {
  ...
  1,  // number of fields
  sizeof(action_commands::action::FollowGPSWaypoints_Feedback),
...
{
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_Feedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_Feedback)() {
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_Feedback_message_type_support_handle;
}
...
void FollowGPSWaypoints_SendGoal_Request_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) action_commands::action::FollowGPSWaypoints_SendGoal_Request(_init);
}

void FollowGPSWaypoints_SendGoal_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_commands::action::FollowGPSWaypoints_SendGoal_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FollowGPSWaypoints_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_SendGoal_Request, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<action_commands::action::FollowGPSWaypoints_Goal>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_SendGoal_Request, goal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FollowGPSWaypoints_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(action_commands::action::FollowGPSWaypoints_SendGoal_Request),
...
{
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_SendGoal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_SendGoal_Request)() {
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_SendGoal_Request_message_type_support_handle;
}
...
void FollowGPSWaypoints_SendGoal_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) action_commands::action::FollowGPSWaypoints_SendGoal_Response(_init);
}

void FollowGPSWaypoints_SendGoal_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_commands::action::FollowGPSWaypoints_SendGoal_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FollowGPSWaypoints_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_SendGoal_Response, accepted),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_SendGoal_Response, stamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FollowGPSWaypoints_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(action_commands::action::FollowGPSWaypoints_SendGoal_Response),
...
{
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_SendGoal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_SendGoal_Response)() {
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_SendGoal_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers FollowGPSWaypoints_SendGoal_service_members = {
  "action_commands::action",  // service namespace
  "FollowGPSWaypoints_SendGoal",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<action_commands::action::FollowGPSWaypoints_SendGoal>()
...
get_service_type_support_handle<action_commands::action::FollowGPSWaypoints_SendGoal>()
{
  ...
  auto service_type_support =
    &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_SendGoal_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::action_commands::action::FollowGPSWaypoints_SendGoal_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::action_commands::action::FollowGPSWaypoints_SendGoal_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_SendGoal)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<action_commands::action::FollowGPSWaypoints_SendGoal>();
}
...
void FollowGPSWaypoints_GetResult_Request_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) action_commands::action::FollowGPSWaypoints_GetResult_Request(_init);
}

void FollowGPSWaypoints_GetResult_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_commands::action::FollowGPSWaypoints_GetResult_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FollowGPSWaypoints_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_GetResult_Request, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FollowGPSWaypoints_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(action_commands::action::FollowGPSWaypoints_GetResult_Request),
...
{
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_GetResult_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_GetResult_Request)() {
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_GetResult_Request_message_type_support_handle;
}
...
void FollowGPSWaypoints_GetResult_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) action_commands::action::FollowGPSWaypoints_GetResult_Response(_init);
}

void FollowGPSWaypoints_GetResult_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_commands::action::FollowGPSWaypoints_GetResult_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FollowGPSWaypoints_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_GetResult_Response, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<action_commands::action::FollowGPSWaypoints_Result>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_GetResult_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FollowGPSWaypoints_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(action_commands::action::FollowGPSWaypoints_GetResult_Response),
...
{
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_GetResult_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_GetResult_Response)() {
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_GetResult_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers FollowGPSWaypoints_GetResult_service_members = {
  ...
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<action_commands::action::FollowGPSWaypoints_GetResult>()
  nullptr,  // request message
  nullptr  // response message
};
...
get_service_type_support_handle<action_commands::action::FollowGPSWaypoints_GetResult>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_GetResult_service_type_support_handle;
  // get a non-const and properly typed version of the data void *
  auto service_members = const_cast<::rosidl_typesupport_introspection_cpp::ServiceMembers *>(
    static_cast<const ::rosidl_typesupport_introspection_cpp::ServiceMembers *>(
      service_type_support->data));
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::action_commands::action::FollowGPSWaypoints_GetResult_Request
      >()->data
      );
    // initialize the response_members_ with the static function from the external library
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::action_commands::action::FollowGPSWaypoints_GetResult_Response
      >()->data
      );
  }
  // finally return the properly initialized service_type_support handle
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_GetResult)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<action_commands::action::FollowGPSWaypoints_GetResult>();
}
...
void FollowGPSWaypoints_FeedbackMessage_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) action_commands::action::FollowGPSWaypoints_FeedbackMessage(_init);
}

void FollowGPSWaypoints_FeedbackMessage_fini_function(void * message_memory)
{
  auto typed_message = static_cast<action_commands::action::FollowGPSWaypoints_FeedbackMessage *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember FollowGPSWaypoints_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_FeedbackMessage, goal_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<action_commands::action::FollowGPSWaypoints_Feedback>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(action_commands::action::FollowGPSWaypoints_FeedbackMessage, feedback),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FollowGPSWaypoints_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(action_commands::action::FollowGPSWaypoints_FeedbackMessage),
...
{
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_FeedbackMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, action_commands, action, FollowGPSWaypoints_FeedbackMessage)() {
  return &::action_commands::action::rosidl_typesupport_introspection_cpp::FollowGPSWaypoints_FeedbackMessage_message_type_support_handle;
}
